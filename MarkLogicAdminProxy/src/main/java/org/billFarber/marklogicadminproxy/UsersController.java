...
/**
 * Controller for proxying MarkLogic User Management API endpoints.
 * 
 * API Documentation:
 * https://docs.marklogic.com/REST/GET/manage/v2/users
 * https://docs.marklogic.com/REST/GET/manage/v2/users/[id-or-name]/properties
 * 
 * This resource address returns data about the Users in the Security database.
 * The data returned depends on the setting of the format request parameter.
 * 
 * Supported parameters for /users:
 * - format: The format of the returned data (html, json, xml - default)
 * 
 * Supported parameters for /users/{id|name}/properties:
...
public class UsersController {
    ...
    public ResponseEntity<String> getUsers(
        ...
        try {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl
                    .parse(marklogicSchema + "://" + marklogicHost + ":8002/manage/v2/users")
                    .newBuilder();
    ...
    @GetMapping("/manage/v2/users/{idOrName}/properties")
    public ResponseEntity<String> getUserProperties(
        ...
        // Validate format parameter - user properties only supports json and xml (no
        // html)
        ...
        try {
            ...
            // Build the URL for the MarkLogic management API
            HttpUrl.Builder urlBuilder = HttpUrl
                    .parse(marklogicSchema + "://" + marklogicHost + ":8002/manage/v2/users/" + idOrName
                            + "/properties")
                    .newBuilder();
