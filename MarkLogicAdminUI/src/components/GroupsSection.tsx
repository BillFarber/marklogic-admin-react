...
export const GroupsSection = React.memo(function GroupsSection({
  groups,
  groupDetails,
  hoveredGroup,
  setHoveredGroup,
  ...
  if (
    !groups ||
    !Array.isArray(groups['group-default-list']?.['list-items']?.['list-item'])
  ) {
    return null;
  }

  const groupsList = groups['group-default-list']['list-items'][
    'list-item'
